...
> 这里复刻网上各大热门 AI 视频/图像的提示词创作脚本，跟着我的创作脚本走，你也能早日学会创造出 AI 神作！

本仓库收录了我在 AI 文生视频、文生图领域的创作探索，涵盖多种风格与主题的提示词工程实践。
...
| 文件 | 简介 |
|------|------|
| 🎨 `文生图提示词合集.md` | 6个实用文生图提示词（纳米AI / 即梦测试）：工业线稿、Minecraft世界、真人化、CV标注、City Pop、手写信纸 |
